...
> **WICHTIG**: Diese Übung ist veraltet und wird bald entfernt oder aktualisiert. Die Anweisungen sind nicht mehr korrekt, und die Übung wird nicht unterstützt.
...
1. Wählen Sie unter `https://app.fabric.microsoft.com/home?experience=fabric` auf der [Microsoft Fabric-Startseite](https://app.fabric.microsoft.com/home?experience=fabric) die Option **Data Activator** aus.
